	...
	<?php 
		 ...
		 if(isset($_POST['sub'])){
			if($err == 0){
				...
				$city->CountryId =  $_POST["country"];
				$city->Operation = "Insert";
				if($city->Insert()){
                                ...
                                <div id="collapseOne" class="accordion-body body in" style="height: auto;">
                                    <form action="" class="form-horizontal" id="block-validate" method="post" novalidate>
                                        ...
                                        <div class="form-actions no-margin-bottom" style="text-align:center;">
                                            <input type="submit" value="Add City" style="margin-left:104px" class="btn btn-primary btn-lg " name="sub">
                                        </div>
