       ...
       <div id="left" >
            <div class="media user-media well-small">
                ...
                <div class="media-body">
                    <h5 class="media-heading">Farhad Evan</h5>
		...
		<?php include_once("Controller/controlPages.php"); ?>
